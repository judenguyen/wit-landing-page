...
const LaunchCountdown = ({ days, hours, minutes, seconds }) => {
    ...
    return (
        <>
            <Countdown prev={0} count={remainTime.days} label={'D'} />
            <span>
                <Countdown prev={0} count={remainTime.hours} label={':'} />
                <Countdown prev={0} count={remainTime.minutes} label={':'} />
                <Countdown prev={0} count={remainTime.seconds} />
            </span>
